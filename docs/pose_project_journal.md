...
- The team behind the COCO dataset created a metric called Object Keypoint Similarity
  - The "Keypoint Similarity" part is essentially a Euclidean distance metric calculation between the coordinates of the ground truth label and the predicted keypoint coordinates with some additional considerations
    ...
    - <figure>
	  <img
	  src="../../media/Pasted%20image%2020220830001043.png?raw=true"
	  alt="The beautiful MDN logo.">
	  <figcaption>Image source source from <a href="https://openaccess.thecvf.com/content_ICCV_2017/papers/Ronchi_Benchmarking_and_Error_ICCV_2017_paper.pdf">Benchmarking and Error Diagnosis in Multi-Instance Pose Estimation</a></figcaption>
	</figure>	
